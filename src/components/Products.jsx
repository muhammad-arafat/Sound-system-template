  ...
  return (
    ...
    >
      <div className='flex-1 relative overflow-hidden'>
        ...
        {isHovered && (
          <div className='absolute inset-0 flex flex-col items-center text-start justify-center px-3 bg-black bg-opacity-65 transition-opacity duration-500 ease-in-out'>
...
const Products = () => {
  return (
    <div className='min-h-screen 2xl:min-h-[80vh] flex justify-center items-center bg-product bg-no-repeat bg-cover bg-fixed w-full bg-center my-10 lg:my-20'>
